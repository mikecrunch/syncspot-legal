...
never see, collect, store, or sell any of it. The extension sends nothing to us at all.**
...
we hold outside your browser: nothing. All data stays in your browser and in your own HubSpot account.

## Where data is sent

Your CRM data goes to exactly one place: **the HubSpot API (`api.hubapi.com`)**, over HTTPS,
authenticated with your own token, into your own HubSpot account. Beyond the LinkedIn page
you are already on, the extension talks to no other host. LinkedIn pages are only read,
never written to, and no data is sent to LinkedIn.

## What we do NOT do

- We do not operate any servers; your CRM data never passes through us. We receive nothing.
- We do not collect analytics or usage statistics of any kind — no page content, no
  browsing history, no crash dumps, no telemetry.
- We do not sell data. We do not transfer it to any third party.
- We do not use data for advertising or for creditworthiness/lending decisions.
